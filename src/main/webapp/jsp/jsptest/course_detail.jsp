...
<link rel="stylesheet" href="${pageContext.request.contextPath}/jsp/jsptest/bootstrap.min.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/jsp/jsptest/scaffolding.less">
<link href="${pageContext.request.contextPath}/jsp/jsptest/achievementMain.css" rel="stylesheet">
<link rel="stylesheet" href="${pageContext.request.contextPath}/jsp/jsptest/course3.css">
<script src="${pageContext.request.contextPath}/jsp/jsptest/jquery-3.2.1.js.下载"></script>
</head>
<body>
...
.main_b_m_t .resourcecount{
    ...
    <script src="${pageContext.request.contextPath}/jsp/jsptest/jquery.min (1).js.下载"></script>
    <script type="text/javascript">
        $(function (){
            var order=1;
   ...
   background-size: cover;">
          ...
          <span style=" padding-left: 20%">
              ...
              <li class="li1"><a href="${pageContext.request.contextPath}/teacher/toCourseDetail/3334C5DC8CE2451AA5B8B1C78EFBA204">微信端</a>
                  <div class="erweima">
                      <img src="${pageContext.request.contextPath}/jsp/jsptest/erweima.png" alt="">
                  </div>
              </li>
              <li>|</li>
