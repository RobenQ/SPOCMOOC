	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_departments')
					.bootstrapTable(
							{
								url : '${pageContext.request.contextPath}/admin/getStudentInfo', //请求后台的URL（*）
								method : 'get', //请求方式（*）
												...
												'click #resetPas' : function(
													...
													$
															.ajax({
																async : true,
																cache : false,
																url : "${pageContext.request.contextPath}/admin/resetStudentPassword/"
																		+ id,
																type : "get",
																dataType : "text",
																success : function(
										...
										},
										{
											...
											events : {
												'click #edit' : function(event,
													...
													document
															.getElementById("studentId").value = id;
													document
															.getElementById("studentIdB").value = id;
													document
															.getElementById("studentName").value = name;
													if (gender == "男") {
														document
			...
			<nav class="navbar-default navbar-side" role="navigation"
				...
				<ul class="nav" id="main-menu">
					...
					<li><a
						...
						style="font-size: 20px; background-color: #f8f8f8">学生信息管理</a></li>
					<li><a
