	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_departments')
					.bootstrapTable(
							{
								url : '${pageContext.request.contextPath}/admin/readRealClassInfo', //请求后台的URL（*）
								method : 'get', //请求方式（*）
										...
										},
										{
											...
											events : {
												'click #edit' : function(event,
													...
													document
															.getElementById("realClassNum").value = id;
													document
															.getElementById("realClassPersonNum").value = amount;
													//document
													//		.getElementById("editCategoryName").value = amount;
													$('#Edit').modal('show');
												}
											}
										} ],
