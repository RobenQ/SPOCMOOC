...
<title>教师作业详情页</title>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/teacher/teacher_homework_detail.css" />
<script
	src="${pageContext.request.contextPath}/js/teacher_homework_detail.js"></script>
<link rel="stylesheet"
...
<body>
	...
	<div class="homework_submit">
		...
		<ul class="change_situation">
			<li class="left" id="already_submit" onclick="already()"
				style="background: coral;">已提交&nbsp;&nbsp;<span>30/43</span></li>
		...
		<ul id="submit_detail">
			<li class="sbumit_detail_li">
				...
				<p class="information">
					<span>162056201</span>&nbsp;&nbsp;<span>赵婉婷</span>
				</p>
				<div class="submit_content">
					...
					<p class="p">
						<span>12</span>月<span>27</span>日&nbsp;<span>08：52</span>提交
					</p>
					<a>写评语</a> <a class="right">评分</a>
				</div>
			</li>
			<li class="sbumit_detail_li">
				<p class="photo">
		...
		<ul id="list">
			<li id="li">
				<ul>
					<li class="left" style="margin-top: 0.5%;"><img
						src="img/头像.png" /></li>
