...
<div class="main_b_b">
    <div class="inner1">
        ...
        <div class="word">
            <div class="images">
                <img src="${pageContext.request.contextPath}/images/video2.png" alt="" style="width:80px;height:80px;"/>
            </div>
            <div class="word_r">
                <p>&nbsp;&nbsp;&nbsp;名称：java</p>
                <p>&nbsp;&nbsp;&nbsp;相关知识点：collection</p>
        ...
        <div class="word">
            <div class="images">
                <img src="../images/video3.png" alt="" style="width:80px;height:80px;"/>
            </div>
            <div class="word_r">
                <p>&nbsp;&nbsp;&nbsp;名称：java</p>
                <p>&nbsp;&nbsp;&nbsp;相关知识点：collection</p>
        ...
        <div class="word">
            <div class="images">
                <img src="../images/video4.png" alt="" style="width:80px;height:80px;"/>
            </div>
            <div class="word_r">
               <p>&nbsp;&nbsp;&nbsp;名称：java</p>
                <p>&nbsp;&nbsp;&nbsp;相关知识点：collection</p>
        ...
        <div class="word">
            <div class="images">
                <img src="../images/video5.png" alt="" style="width:80px;height:80px;"/>
            </div>
            <div class="word_r">
                <p>&nbsp;&nbsp;&nbsp;名称：java</p>
                <p>&nbsp;&nbsp;&nbsp;相关知识点：collection</p>
        ...
        <div class="word">
            <div class="images">
                <img src="../images/video6.png" alt="" style="width:80px;height:80px;"/>
            </div>
            <div class="word_r">
                <p>&nbsp;&nbsp;&nbsp;发布人：张XX</p>
                <p>&nbsp;&nbsp;&nbsp;大致内容：罗马假日</p>
