                    ...
                    <div class="ace-paper-cont clear-mrg">
                        ...
                        <div class="padd-box">
                            ...
                            <section class="section clear-mrg">
                                <h2 class="title-lg text-upper">资源</h2>

                                <div class="padd-box-sm clear-mrg">
                                 <c:forEach items="${taskList }" var="task">
                                    <div class="pf-grid-item ">
                                        <div class="ref-box brd-btm hreview project pf-btn-view  " href="#pf-popup-2">
                                        ...
                                        <div id="pf-popup-2" class="pf-popup clearfix">
                                            ...
                                            <div class="pf-popup-col2">
                                                <div class="pf-popup-info clear-mrg">
                                                    <h2 class="text-upper">${task.task_title }</h2>
                                                    <p class="text-muted"><strong>任务分类 ：${task.task_category }</strong></p>
                                                    <dl class="dl-horizontal">
                                                        <dt>开始时间:</dt>
                                                        <dd>${task.publishTime }</dd>

                                                        <dt>任务分值:</dt>
                                                        <dd><a href="www.sitedomen.com">${task.taskPoint }</a></dd>

                                                        <dt>截止时间:</dt>
                                                        <dd>${task.taskEndTime }</dd>
                                                    </dl>
                                                    <p>${task.taskDetail }</p>
                                                    <button>修改任务</button>
                                                </div><!-- .pf-popup-info -->
                            ...
                            <section class="section clear-mrg">
                                ...
                                <div class="padd-box-sm">
                                    <ul class="clients">
                                        <li><a href=""><img src="img/uploads/logos/logo-wordpress.png" alt="WordPress"></a>
                                        </li>
                                        <li>
        ...
        <div id="ace-sidebar-inner">
            ...
            <aside class="widget-area">
                ...
                <section id="tag_cloud-2" class="widget widget_tag_cloud">
                    ...
                    <div class="tagcloud">
                        <a href="#tag/audios/" class="tag-link-5 tag-link-position-1" title="1 topic"
                           style="font-size: 1em;">Audios</a>
                        <a href="" class="tag-link-7 tag-link-position-2" title="1 topic" style="font-size: 1em;">Freelance</a>
                    </div>
                </section>
    ...
    <footer id="ace-footer" class="ace-container-shift">
        <div class="ace-container">
            <div class="ace-footer-cont clear-mrg">
                <p class="text-center">Copyright &copy; 2017.Company name All rights reserved.More Templates <a
