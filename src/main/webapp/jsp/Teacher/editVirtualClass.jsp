...
<<<<<<< HEAD
<<<<<<< HEAD
							<option>${listTerm.startYear }/${listTerm.endYear }${listTerm.term
								}</option>
...
>>>>>>> 8b686c47d14ac368571e08f4b308c03cc9fa9818
				...
				<div class="input1">
					<span>班级名称：</span> <input name="className" id="className" value="${virtualClassName }"
						style="width: 40%; height: 30px; float: left; margin-left: 2%;">
				</div>
					...
					<div class="friend">
						<ul id="selectedRealClassUI" style="list-style-type: none;">
							<li id="selectedRealClass" name=“selectedRealClass”
								...
								<c:forEach items="${listRealClass }" var="realClass">
									<li id="selectedRealClass" name=“selectedRealClass”
									style="float: left; margin-left: 2%;">
										<input value="${realClass.realClassNum }" name='selectedRealClassContent' id='selectedRealClassContent'/>
									</li>	
								</c:forEach>
						</ul>
						<div class="add">
						...
						<input value="" name='realClassCosntent' id='realClassContent'
							type="hidden" />
					</div>
				</div>
				<hr>
